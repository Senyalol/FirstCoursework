                ...
                if (Checkers(classOrgan))
                {
                    ...
                    if (Checkers(speciesOrgan))
                    {
                        ...
                        if (NumberCheckers(CountI.Text))
                        {
                            ...
                            {
                                predator.Name = NameI.Text;
                                predator.Class = ClassI.Text;
                                predator.Species = SpeciesI.Text;
                                predator.Quantity = Convert.ToInt32(CountI.Text);
                                predator.Behavior = BehaviourI.Text;
                                ...
                                if (!organismExists2)
                                {
                                            ...
                                            SomeDataAboutPredator.AddPredator(predator);

                                            MessageBox.Show("Хищник " + predator.Name + " был добавлен");
                            ...
                            {
                                MessageBox.Show("Вы не можете изменить класс вида хищник на " + classOrgan);
                            }
